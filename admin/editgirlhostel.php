    ...
    while($row = mysqli_fetch_assoc($result)){
        ?>   
            <tr>
                ...
                <td><a href="updategirlhostel.php?girl_hostel_id=<?php echo $row['girl_hostel_id']?>" style="text-decoration:none;"><i class="fas fa-edit"></i></a></td>
                    <td><a href="deletegirlhostel.php?girl_hostel_id=<?php echo $row['girl_hostel_id']?>"style="text-decoration:none;color:red;"><i class="fas fa-trash"></i></a></td>
            </tr>
