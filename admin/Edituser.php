    ...
    while($row = mysqli_fetch_assoc($result)){
        ?>   
            <tr>
                ...
                <td><a href="updateuser.php?user_id=<?php echo $row['user_id']?>" style="text-decoration:none;"><i class="fas fa-edit"></i></a></td>
                    <td><a href="deleteuser.php?user_id=<?php echo $row['user_id']?>"style="text-decoration:none;color:red;"><i class="fas fa-trash"></i></a></td>
